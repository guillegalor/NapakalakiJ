...
public class Dice extends javax.swing.JDialog {
  ...
  public int nextNumber () {
    return nextNumber ("Pincha en el dado",
            "o pulsa ENTER para pararlo");
  ...
  private void jL_diceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jL_diceMouseClicked
        ...
        pack();
        jL_dice.setFocusable(false);
        jB_OK.setFocusable(true);
  ...
  private void jB_OKKeyPressed(java.awt.event.KeyEvent evt){
